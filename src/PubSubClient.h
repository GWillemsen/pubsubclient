...
private:
   ...
   MQTT_CALLBACK_USER_DATA_SIGNATURE;
...
public:
   ...
   PubSubClient& setCallback(MQTT_CALLBACK_USER_DATA_SIGNATURE, void *userdata);
   ...
   int state();
private:
   static void internalCallbackHandler(char*, uint8_t*, unsigned int, void *);
};
